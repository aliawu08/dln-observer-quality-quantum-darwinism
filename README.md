...
| **Tight exponent gap** | Factor-of-two Chernoff exponent separation (&xi;_N / &xi;_L = 2) between product and collective decoding for pure-state records, achievable by Helstrom and Breidbart measurements |
